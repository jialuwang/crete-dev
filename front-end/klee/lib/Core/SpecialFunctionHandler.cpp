...
/*void SpecialFunctionHandler::handleDMATrue(ExecutionState &state,
                                              KInstruction *target,
                                              std::vector<ref<Expr> > &arguments) {

	state.isDMARead = true;
}
void SpecialFunctionHandler::handleDMAFalse(ExecutionState &state,
                                              KInstruction *target,
                                              std::vector<ref<Expr> > &arguments) {

	state.isDMARead = false;
}*/
