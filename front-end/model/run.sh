...
rm -f ../trace_parser/pci_dma_data
...
#/home/jialuwang/crete/crete-dev/front-end/qemu-2.3/x86_64-softmmu/crete-qemu-2.3-system-x86_64 -k us -m 2048 -net nic,model=e1000 -enable-kvm -serial stdio ~/qklee/img/crete.img

/home/jialuwang/crete/crete-dev/front-end/qemu-2.3/x86_64-softmmu/crete-qemu-2.3-system-x86_64 -k us -m 1024 -net nic,model=e1000 -net user -redir tcp:2022::22 -loadvm test -serial stdio ~/qklee/img/ubuntu-14.04-4.10.img -monitor telnet:127.0.0.1:1234,server,nowait
